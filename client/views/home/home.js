...
Template.HomeEspecialidades.events({

});

Template.HomeEspecialidades.helpers({
	...
	"submit": function(e, t) {
		...
		validateForm(
			...
			function(values) {
				...
				Meteor.call('sendMail', { from: values.email, to: values.email, subject: 'Message from ' + values.name, text: values.message }, function(e) {  if(e) errorAction(e.message); else submitAction('Su mensaje se ha enviado. ¡Gracias por contactarnos! :)'); } );
			}
		);
